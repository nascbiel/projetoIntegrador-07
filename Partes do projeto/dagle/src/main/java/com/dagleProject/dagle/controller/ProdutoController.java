...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> GetAllProdutosByIdUsuario(@PathVariable long idUsuario){
		return ResponseEntity.ok(repository.buscarProdutoPorIdUsuario(idUsuario));
	}
