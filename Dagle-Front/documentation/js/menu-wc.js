...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">dagle documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-5bce8b5bee93f684ca0e84f9502927be"' : 'data-target="#xs-components-links-module-AppModule-5bce8b5bee93f684ca0e84f9502927be"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-5bce8b5bee93f684ca0e84f9502927be"' :
                                            'id="xs-components-links-module-AppModule-5bce8b5bee93f684ca0e84f9502927be"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/EstoqueComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">EstoqueComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ServicosComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ServicosComponent</a>
                                            </li>
                                            <li class="link">
